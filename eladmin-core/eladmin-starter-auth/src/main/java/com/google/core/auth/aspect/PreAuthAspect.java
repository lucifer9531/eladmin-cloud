package com.google.core.auth.aspect;
...
public class PreAuthAspect {
    ...
    @Around("@annotation(com.google.core.auth.annotation.PreAuth)")
    ...
    public boolean hasPerm(String permission) {
        ...
        Map<String, Object> data = (Map<String, Object>) redisService.get(Oauth2Constant.EL_ADMIN_PERMISSION_PREFIX
