...
public class SwaggerConfiguration implements WebMvcConfigurer {
    ...
    private ApiInfo groupApiInfo() {
        return new ApiInfoBuilder()
                ...
                .version(ElAdminConstant.EL_ADMIN_APP_VERSION)
                .build();
    }
    ...
    /**
     * 解决与knife4j有兼容问题
     * @see <a href="https://github.com/xiaoymin/swagger-bootstrap-ui/issues/396">...</a>
     * @see <a href="https://github.com/springfox/springfox/issues/3462">...</a>
     * @return
     */
    @Bean
