package com.google.gateway.rule;
...
public class VersionGrayLoadBalancer implements GrayLoadBalancer {
	...
	public ServiceInstance choose(String serviceId, ServerHttpRequest request) {
		...
		String reqVersion = request.getHeaders().getFirst(ElAdminConstant.VERSION);
		...
		for (ServiceInstance instance : instances) {
			...
			String targetVersion = MapUtil.getStr(metadata, ElAdminConstant.VERSION);
